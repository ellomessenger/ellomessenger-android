...
public class LocationSharingService extends Service implements NotificationCenter.NotificationCenterDelegate {
	...
	private void updateNotification(boolean post) {
		...
		String text = String.format(str, getString(R.string.AttachLiveLocation), param);
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if (builder == null) {
			...
			PendingIntent contentIntent = PendingIntent.getActivity(ApplicationLoader.applicationContext, 0, intent2, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
			...
			builder.addAction(0, getString(R.string.StopLiveLocation), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 2, stopIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE));
		}
