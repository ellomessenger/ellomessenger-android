...
public interface ILocationServiceProvider {
	int PRIORITY_HIGH_ACCURACY = 0, PRIORITY_BALANCED_POWER_ACCURACY = 1, PRIORITY_LOW_POWER = 2, PRIORITY_NO_POWER = 3;

	int STATUS_SUCCESS = 0, STATUS_RESOLUTION_REQUIRED = 1, STATUS_SETTINGS_CHANGE_UNAVAILABLE = 2;
