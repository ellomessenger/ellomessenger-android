...
public class BitmapsCache {
	...
	public void createCache() {
		try {
			...
			FileLog.d("generate cache for time = " + (System.currentTimeMillis() - time) + " drawFrameTime = " + bitmapFrameTime + " compressQuality = " + compressQuality + " fileSize = " + AndroidUtilities.formatFileSize(file.length()) + " " + fileName);
		}
...
//        cancelled.set(true);
	...
	private static class FrameOffset {
		final int index;
		int frameSize;
		int frameOffset;
