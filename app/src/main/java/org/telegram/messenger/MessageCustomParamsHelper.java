...
public class MessageCustomParamsHelper {
    ...
    public static void copyParams(Message fromMessage, Message toMessage) {
    ...
    public static void readLocalParams(Message message, NativeByteBuffer byteBuffer) {
        if (byteBuffer == null) {
            return;
        }
    ...
    public static NativeByteBuffer writeLocalParams(Message message) {
        if (isEmpty(message)) {
            return null;
        }
    ...
    private static class Params_v1 extends TLObject {
        ...
        private Params_v1(Message message) {
