...
public class SRPHelper {
	...
	public static byte[] getX(byte[] passwordBytes, TLRPC.TLPasswordKdfAlgoModPow algo) {
	...
	public static BigInteger getV(byte[] passwordBytes, TLRPC.TLPasswordKdfAlgoModPow algo) {
	...
	public static byte[] getVBytes(byte[] passwordBytes, TLRPC.TLPasswordKdfAlgoModPow algo) {
	...
	public static TLRPC.TLInputCheckPasswordSRP startCheck(byte[] x_bytes, long srp_id, byte[] srp_B, TLRPC.TLPasswordKdfAlgoModPow algo) {
		...
		TLRPC.TLInputCheckPasswordSRP result = new TLRPC.TLInputCheckPasswordSRP();
