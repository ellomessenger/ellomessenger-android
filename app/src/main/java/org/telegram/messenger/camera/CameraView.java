...
public class CameraView extends FrameLayout implements TextureView.SurfaceTextureListener {
	...
	private final Matrix txform = new Matrix();
	...
	@Override
	public void onSurfaceTextureSizeChanged(@NonNull SurfaceTexture surfaceTexture, int surfaceW, int surfaceH) {
		checkPreviewMatrix();
	}
	...
	private class VideoRecorder implements Runnable {
		...
		private final boolean videoConvertFirstWrite = true;
		...
		private final ArrayList<InstantCameraView.AudioBufferInfo> buffersToWrite = new ArrayList<>();
		...
		private final ArrayBlockingQueue<InstantCameraView.AudioBufferInfo> buffers = new ArrayBlockingQueue<>(10);
