...
public final class Instance {
	...
	public static final List<String> AVAILABLE_VERSIONS = Arrays.asList("4.1.2", "4.0.2", "4.0.1", "4.0.0", "3.0.0", "2.7.7", "2.4.4");
	...
	public static final class Config {
		...
		public String toString() {
			return "Config{" + "initializationTimeout=" + initializationTimeout + ", receiveTimeout=" + receiveTimeout + ", dataSaving=" + dataSaving + ", enableP2p=" + enableP2p + ", enableAec=" + enableAec + ", enableNs=" + enableNs + ", enableAgc=" + enableAgc + ", enableCallUpgrade=" + enableCallUpgrade + ", logPath='" + logPath + '\'' + ", statsLogPath='" + statsLogPath + '\'' + ", maxApiLayer=" + maxApiLayer + ", enableSm=" + enableSm + '}';
		}
	}
	...
	public static final class Endpoint {
		...
		@Override
		public String toString() {
			return "Endpoint{" + "id=" + id + ", ipv4='" + ipv4 + '\'' + ", ipv6='" + ipv6 + '\'' + ", port=" + port + ", type=" + type + ", peerTag=" + Arrays.toString(peerTag) + ", turn=" + turn + ", stun=" + stun + ", username=" + username + ", password=" + password + ", tcp=" + tcp + '}';
		}
	}
	...
	public static final class EncryptionKey {
		...
		@Override
		public String toString() {
			return "EncryptionKey{" + "value=" + Arrays.toString(value) + ", isOutgoing=" + isOutgoing + '}';
		}
	}
	...
	public static final class FinalState {
		...
		@Override
		public String toString() {
			return "FinalState{" + "persistentState=" + Arrays.toString(persistentState) + ", debugLog='" + debugLog + '\'' + ", trafficStats=" + trafficStats + ", isRatingSuggested=" + isRatingSuggested + '}';
		}
	}
	...
	public static final class TrafficStats {
		...
		@Override
		public String toString() {
			return "TrafficStats{" + "bytesSentWifi=" + bytesSentWifi + ", bytesReceivedWifi=" + bytesReceivedWifi + ", bytesSentMobile=" + bytesSentMobile + ", bytesReceivedMobile=" + bytesReceivedMobile + '}';
		}
	}
	...
	public static final class Fingerprint {
		...
		@Override
		public String toString() {
			return "Fingerprint{" + "hash=" + hash + ", setup=" + setup + ", fingerprint=" + fingerprint + '}';
		}
	}
	...
	public static final class Candidate {
		...
		@Override
		public String toString() {
			return "Candidate{" + "port=" + port + ", protocol=" + protocol + ", network=" + network + ", generation=" + generation + ", id=" + id + ", component=" + component + ", foundation=" + foundation + ", priority=" + priority + ", ip=" + ip + ", type=" + type + ", tcpType=" + tcpType + ", relAddr=" + relAddr + ", relPort=" + relPort + '}';
		}
	}
