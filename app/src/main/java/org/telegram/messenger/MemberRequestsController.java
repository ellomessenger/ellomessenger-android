...
public class MemberRequestsController extends BaseController {
    ...
    public int getImporters(final long chatId, final String query, TLRPC.TL_chatInviteImporter lastImporter, LongSparseArray<User> users, RequestDelegate onComplete) {
