...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
	public static final String NOTIFY_PREVIOUS = "com.beint.elloapp.android.musicplayer.previous";
	public static final String NOTIFY_CLOSE = "com.beint.elloapp.android.musicplayer.close";
	public static final String NOTIFY_PAUSE = "com.beint.elloapp.android.musicplayer.pause";
	public static final String NOTIFY_PLAY = "com.beint.elloapp.android.musicplayer.play";
	public static final String NOTIFY_NEXT = "com.beint.elloapp.android.musicplayer.next";
	public static final String NOTIFY_SEEK = "com.beint.elloapp.android.musicplayer.seek";
	...
	private static final boolean supportBigNotifications = Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN;
	private static final boolean supportLockScreenControls = Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP || !TextUtils.isEmpty(AndroidUtilities.getSystemProperty("ro.miui.ui.version.code"));
			...
			if (supportLockScreenControls) {
				...
				try {
					if (remoteControlClient == null) {
						...
						PendingIntent mediaPendingIntent = PendingIntent.getBroadcast(this, 0, mediaButtonIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
