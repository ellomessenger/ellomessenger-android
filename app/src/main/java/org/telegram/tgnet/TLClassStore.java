...
public class TLClassStore {
	private final SparseArray<Class<?>> classStore;
	private static TLClassStore store = null;
	...
	public TLClassStore() {
		...
		classStore.put(TL_error.CONSTRUCTOR, TL_error.class);
	...
	public TLObject TLdeserialize(NativeByteBuffer stream, int constructor, boolean exception) {
		var objClass = classStore.get(constructor);
