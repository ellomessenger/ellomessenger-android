...
class TL_messageEntityPre : MessageEntity() {
	override fun equals(other: Any?): Boolean {
		if (other !is TL_messageEntityPre) {
			return false
		}
		...
		return offset == other.offset && length == other.length && language == other.language
	}
	...
	override fun hashCode(): Int {
		return Objects.hash(CONSTRUCTOR, offset, length, language)
	}

	companion object {
		const val CONSTRUCTOR = 0x73924be0
	}
}
