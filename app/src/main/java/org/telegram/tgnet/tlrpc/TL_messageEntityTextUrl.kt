...
class TL_messageEntityTextUrl : MessageEntity() {
	override fun equals(other: Any?): Boolean {
		if (other !is TL_messageEntityTextUrl) {
			return false
		}
	...
	override fun hashCode(): Int {
		return Objects.hash(CONSTRUCTOR, offset, length, url)
	}

	companion object {
		const val CONSTRUCTOR = 0x76a6d327
	}
}
