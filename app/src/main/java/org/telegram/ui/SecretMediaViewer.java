...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
	...
	private final PhotoBackgroundDrawable photoBackgroundDrawable = new PhotoBackgroundDrawable(0xff000000);
	...
	public void openMedia(MessageObject messageObject, PhotoViewer.PhotoViewerProvider provider, Runnable onOpen) {
		...
		currentDialogId = MessageObject.getPeerId(messageObject.messageOwner.peerId);
		...
		imageMoveAnimation.playTogether(ObjectAnimator.ofFloat(actionBar, View.ALPHA, 0, 1.0f), ObjectAnimator.ofFloat(secretDeleteTimer, View.ALPHA, 0, 1.0f), ObjectAnimator.ofInt(photoBackgroundDrawable, AnimationProperties.COLOR_DRAWABLE_ALPHA, 0, 255), ObjectAnimator.ofFloat(secretDeleteTimer, View.ALPHA, 0, 1.0f), ObjectAnimator.ofFloat(this, "animationValue", 0, 1));
	...
	public boolean closePhoto(boolean animated, boolean byDelete) {
		...
		if (currentProvider == null || TLRPCExtensions.getPhoto(TLRPCExtensions.getMedia(currentMessageObject.messageOwner)) instanceof TLRPC.TLPhotoEmpty || TLRPCExtensions.getDocument(TLRPCExtensions.getMedia(currentMessageObject.messageOwner)) instanceof TLRPC.TLDocumentEmpty) {
			object = null;
		}
		else {
		...
		if (animated) {
			...
			if (isVideo) {
				videoCrossfadeStarted = false;
				textureUploaded = false;
				imageMoveAnimation.playTogether(ObjectAnimator.ofInt(photoBackgroundDrawable, AnimationProperties.COLOR_DRAWABLE_ALPHA, 0), ObjectAnimator.ofFloat(this, "animationValue", 0, 1), ObjectAnimator.ofFloat(actionBar, View.ALPHA, 0), ObjectAnimator.ofFloat(secretDeleteTimer, View.ALPHA, 0), ObjectAnimator.ofFloat(this, "videoCrossfadeAlpha", 0));
			}
			else {
				centerImage.setManualAlphaAnimator(true);
				imageMoveAnimation.playTogether(ObjectAnimator.ofInt(photoBackgroundDrawable, AnimationProperties.COLOR_DRAWABLE_ALPHA, 0), ObjectAnimator.ofFloat(this, "animationValue", 0, 1), ObjectAnimator.ofFloat(actionBar, View.ALPHA, 0), ObjectAnimator.ofFloat(secretDeleteTimer, View.ALPHA, 0), ObjectAnimator.ofFloat(centerImage, "currentAlpha", 0.0f));
			}
			...
			animatorSet.playTogether(ObjectAnimator.ofFloat(containerView, View.SCALE_X, 0.9f), ObjectAnimator.ofFloat(containerView, View.SCALE_Y, 0.9f), ObjectAnimator.ofInt(photoBackgroundDrawable, AnimationProperties.COLOR_DRAWABLE_ALPHA, 0), ObjectAnimator.ofFloat(actionBar, View.ALPHA, 0));
