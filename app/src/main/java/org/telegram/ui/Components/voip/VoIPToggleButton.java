        ...
        if (currentIconRes != 0) {
            if (drawCross || crossProgress != 0) {
                ...
                if (crossProgress > 0) {
                    ...
                    float startY = top + AndroidUtilities.dpf2(8) + crossOffset;

                    float endX = startX - AndroidUtilities.dp(1) + AndroidUtilities.dp(23) * CubicBezierInterpolator.DEFAULT.getInterpolation(crossProgress);
                    float endY = startY + AndroidUtilities.dp(23) * CubicBezierInterpolator.DEFAULT.getInterpolation(crossProgress);
