...
public class SlotsDrawable extends RLottieDrawable {
	enum ReelValue {
		bar, berries, lemon, seven, sevenWin
	}
	...
	private ReelValue reelValue(int rawValue) {
		return switch (rawValue) {
			case 0 -> ReelValue.bar;
			case 1 -> ReelValue.berries;
			case 2 -> ReelValue.lemon;
			default -> ReelValue.seven;
		};
	}
	...
	public boolean setBaseDice(ChatMessageCell messageCell, TLRPC.TLMessagesStickerSet stickerSet) {
		...
		int account = currentMessageObject.currentAccount;
	...
	public boolean setDiceNumber(ChatMessageCell messageCell, int number, TLRPC.TLMessagesStickerSet stickerSet, boolean instant) {
