...
public class PhotoCropView extends FrameLayout {
	...
	private final ImageReceiver thumbImageView;
	...
	public final Property<PhotoCropView, Float> PROGRESS_VALUE = new AnimationProperties.FloatProperty<>("thumbImageVisibleProgress") {
		@Override
	...
	public final Property<PhotoCropView, Float> ANIMATION_VALUE = new AnimationProperties.FloatProperty<>("thumbAnimationProgress") {
		@Override
		public void setValue(PhotoCropView object, float value) {
	...
	protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
		...
		if (thumbImageVisible && child == cropView) {
			...
			thumbImageView.setImageCoordinates(x, y, size, size);
