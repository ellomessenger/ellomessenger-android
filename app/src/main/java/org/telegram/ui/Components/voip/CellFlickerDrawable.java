	...
	public class DrawableInterface extends Drawable {
		...
		public void draw(@NonNull Canvas canvas) {
			...
			if (svgDrawable != null) {
				...
				gradientShader.setLocalMatrix(matrix);
				svgDrawable.setBounds(getBounds().centerX() - drawableSize / 2, getBounds().centerY() - drawableSize / 2, getBounds().centerX() + drawableSize / 2, getBounds().centerY() + drawableSize / 2);
