...
public class TransformableLoginButtonView extends View {
	...
	private final static float BUTTON_RADIUS_DP = 6, CIRCLE_RADIUS_DP = 32, ARROW_PADDING = 21, ARROW_BACK_SIZE = 9, LEFT_CHECK_LINE = 8, RIGHT_CHECK_LINE = 16;
	private final static float BUTTON_TEXT_IN = 0.6f, ARROW_IN = 0.4f;

	@Retention(RetentionPolicy.SOURCE)
	@IntDef({TRANSFORM_OPEN_ARROW, TRANSFORM_ARROW_CHECK})
