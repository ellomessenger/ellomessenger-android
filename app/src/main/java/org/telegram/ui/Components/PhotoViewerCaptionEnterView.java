...
public class PhotoViewerCaptionEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayoutPhoto.SizeNotifierFrameLayoutPhotoDelegate {
	...
	private final SizeNotifierFrameLayoutPhoto sizeNotifierLayout;
	...
	private final TextPaint lengthTextPaint;
	...
	public PhotoViewerCaptionEnterView(Context context, SizeNotifierFrameLayoutPhoto parent, final View window) {
		...
		lengthTextPaint.setTypeface(Theme.TYPEFACE_BOLD);
...
//        }
	...
	private void createEmojiView() {
		...
		emojiView = new EmojiView(null, true, false, false, getContext(), false, null, null);
		...
		public Integer getColor(String key) {
			switch (key) {
				case Theme.key_dialogBackground:
					return -14803426;
				case Theme.key_windowBackgroundWhite:
					return -15198183;
				case Theme.key_windowBackgroundWhiteBlackText:
					return -1;
...
//                case Theme.key_chat_gifSaveHintText: return 0xffff0000;
				case Theme.key_chat_emojiPanelEmptyText:
					return -8553090;
				case Theme.key_progressCircle:
					return -10177027;
				case Theme.key_chat_emojiSearchIcon:
					return -9211020;
				case Theme.key_chat_emojiPanelStickerPackSelector:
				case Theme.key_chat_emojiSearchBackground:
					return 181267199;
//                case Theme.key_chat_emojiPanelStickerSetName: return 0xffff0000;
				case Theme.key_chat_emojiPanelIcon:
					return -9539985;
				case Theme.key_chat_emojiBottomPanelIcon:
					return -9539985;
				case Theme.key_chat_emojiPanelIconSelected:
					return -10177041;
				case Theme.key_chat_emojiPanelStickerPackSelectorLine:
					return -10177041;
				case Theme.key_chat_emojiPanelBackground:
					return -14803425;
				case Theme.key_chat_emojiPanelShadowLine:
					return -1610612736;
				case Theme.key_chat_emojiPanelBackspace:
					return -9539985;
...
//                case Theme.key_featuredStickers_removeButtonText: return 0xffff0000;
				case Theme.key_listSelector:
					return 771751936;
				case Theme.key_divider:
					return -16777216;
			}
			return null;
		}
