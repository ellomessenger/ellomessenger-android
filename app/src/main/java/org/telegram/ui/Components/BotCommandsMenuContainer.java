...
public class BotCommandsMenuContainer extends FrameLayout implements NestedScrollingParent {
	...
	public void updateColors() {
		topBackground.setColor(getContext().getColor(R.color.light_background));
		backgroundPaint.setColor(getContext().getColor(R.color.background));
		shadowDrawable.setColorFilter(new PorterDuffColorFilter(getContext().getColor(R.color.background), PorterDuff.Mode.SRC_IN));
		invalidate();
	}
}
