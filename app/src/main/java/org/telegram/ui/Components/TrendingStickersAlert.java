	...
	private class AlertContainerView extends SizeNotifierFrameLayout {
		...
		protected void onDraw(Canvas canvas) {
			...
			if (fraction > 0f && fraction < 1f) {
				...
				shapeDrawable.setColor(getContext().getColor(R.color.background));
		...
		protected void dispatchDraw(Canvas canvas) {
			...
			if (statusBarAlpha > 0f) {
				paint.setColor(getContext().getColor(R.color.background));
			...
			final int sheetScrollUpColor = getContext().getColor(R.color.light_background);
