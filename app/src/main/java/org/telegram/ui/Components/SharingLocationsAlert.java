...
public class SharingLocationsAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
	...
	private final SharingLocationsAlertDelegate delegate;
	...
	public SharingLocationsAlert(Context context, SharingLocationsAlertDelegate sharingLocationsAlertDelegate) {
		...
		pickerBottomLayout.cancelButton.setTextColor(getContext().getColor(R.color.purple));
		pickerBottomLayout.cancelButton.setText(getContext().getString(R.string.StopAllLocationSharings));
		...
		pickerBottomLayout.doneButtonTextView.setTextColor(getContext().getColor(R.color.brand));
		pickerBottomLayout.doneButtonTextView.setText(getContext().getString(R.string.Close).toUpperCase());
