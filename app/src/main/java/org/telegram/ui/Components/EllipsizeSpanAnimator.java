...
public class EllipsizeSpanAnimator {
	...
	private final ArrayList<View> ellipsizedViews = new ArrayList<>();

	public EllipsizeSpanAnimator(View parentView) {
		ellAnimator = new AnimatorSet();
		ellAnimator.playTogether(createEllipsizeAnimator(ellSpans[0], 0, 255, 0, 300), createEllipsizeAnimator(ellSpans[1], 0, 255, 150, 300), createEllipsizeAnimator(ellSpans[2], 0, 255, 300, 300), createEllipsizeAnimator(ellSpans[0], 255, 0, 1000, 400), createEllipsizeAnimator(ellSpans[1], 255, 0, 1000, 400), createEllipsizeAnimator(ellSpans[2], 255, 0, 1000, 400));
