...
public class VideoTimelineView extends View {
	...
	private final ArrayList<Bitmap> keyframes = new ArrayList<>();
	...
	public void setKeyframes(List<Bitmap> keyframes) {
	...
	public static class TimeHintView extends View {
		...
		private final Drawable tooltipBackgroundArrow;
		private StaticLayout tooltipLayout;
		private final TextPaint tooltipPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
		...
		public TimeHintView(Context context) {
			...
			tooltipPaint.setTypeface(Theme.TYPEFACE_DEFAULT);
		...
		protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
			super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(tooltipLayout.getHeight() + AndroidUtilities.dp(4) + tooltipBackgroundArrow.getIntrinsicHeight(), MeasureSpec.EXACTLY));
		}
		...
		protected void onDraw(@NonNull Canvas canvas) {
			...
			tooltipBackground.setBounds(-AndroidUtilities.dp(8), 0, tooltipLayout.getWidth() + AndroidUtilities.dp(8), (int)(tooltipLayout.getHeight() + AndroidUtilities.dpf2(4)));
			tooltipBackgroundArrow.setBounds(tooltipLayout.getWidth() / 2 - tooltipBackgroundArrow.getIntrinsicWidth() / 2, (int)(tooltipLayout.getHeight() + AndroidUtilities.dpf2(4)), tooltipLayout.getWidth() / 2 + tooltipBackgroundArrow.getIntrinsicWidth() / 2, (int)(tooltipLayout.getHeight() + AndroidUtilities.dpf2(4)) + tooltipBackgroundArrow.getIntrinsicHeight());
