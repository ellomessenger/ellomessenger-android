...
public class VideoSeekPreviewImage extends View {
	...
	private final ImageReceiver youtubeBoardsReceiver;
	...
	public VideoSeekPreviewImage(Context context, VideoSeekPreviewImageDelegate videoSeekPreviewImageDelegate) {
		...
		youtubeBoardsReceiver.setDelegate(new ImageReceiver.ImageReceiverDelegate() {
			@Override
	...
	protected void onDraw(Canvas canvas) {
		...
		if (bitmapToDraw != null && bitmapShader != null) {
			...
			youtubeBoardsReceiver.setImageCoordinates(0, 0, youtubeBoardsReceiver.getBitmapWidth(), youtubeBoardsReceiver.getBitmapHeight());
