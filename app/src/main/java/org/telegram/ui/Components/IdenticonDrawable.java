...
public class IdenticonDrawable extends Drawable {
	...
	private int[] colors = {0xffffffff, 0xffd5e6f3, 0xff2d5775, 0xff2f99c9};
	...
	public void setEncryptedChat(TLRPC.EncryptedChat encryptedChat) {
		data = encryptedChat.keyHash;

		if (data == null) {
			encryptedChat.keyHash = data = AndroidUtilities.calcAuthKeyHash(encryptedChat.authKey);
		}
