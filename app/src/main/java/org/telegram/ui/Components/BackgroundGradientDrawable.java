...
public class BackgroundGradientDrawable extends GradientDrawable {
	...
	public static Orientation getGradientOrientation(int gradientAngle) {
		return switch (gradientAngle) {
			case 0 -> Orientation.BOTTOM_TOP;
			case 90 -> Orientation.LEFT_RIGHT;
			case 135 -> Orientation.TL_BR;
			case 180 -> Orientation.TOP_BOTTOM;
			case 225 -> Orientation.TR_BL;
			case 270 -> Orientation.RIGHT_LEFT;
			case 315 -> Orientation.BR_TL;
			default -> // 45
					Orientation.BL_TR;
		};
	}
