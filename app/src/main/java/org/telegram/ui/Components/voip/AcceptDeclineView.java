...
public class AcceptDeclineView extends View {
	...
	public AcceptDeclineView(@NonNull Context context) {
		...
		buttonWidth = AndroidUtilities.dp(80);
		acceptDrawable = new FabBackgroundDrawable();
		acceptDrawable.setColor(0xFF27AE60);

		declineDrawable = new FabBackgroundDrawable();
		declineDrawable.setColor(0xFFEF4062);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int padding = (buttonWidth - AndroidUtilities.dp(40)) / 2;
		callDrawable.setBounds(padding, padding, padding + AndroidUtilities.dp(40), padding + AndroidUtilities.dp(40));
		cancelDrawable.setBounds(padding, padding, padding + AndroidUtilities.dp(40), padding + AndroidUtilities.dp(40));
