...
public class RecyclerAnimationScrollHelper {
	...
	public void scrollToPosition(int position, int offset, final boolean bottom, boolean smooth) {
		if (recyclerView.isFastScrollAnimationRunning() || (recyclerView.getItemAnimator() != null && recyclerView.getItemAnimator().isRunning())) {
			return;
		}
		...
		recyclerView.setFastScrollAnimationRunning(true);
			...
			public void onLayoutChange(View v, int l, int t, int r, int b, int ol, int ot, int or, int ob) {
				...
				animator.addListener(new AnimatorListenerAdapter() {
					...
					public void onAnimationEnd(Animator animation) {
						...
						recyclerView.setFastScrollAnimationRunning(false);
						...
						if (BuildConfig.DEBUG_PRIVATE_VERSION) {
							if (recyclerView.mChildHelper.getChildCount() != recyclerView.getChildCount()) {
								throw new RuntimeException("views count in child helper must be equals views count in recycler view");
							}
