...
public class GLIconRenderer implements GLSurfaceView.Renderer {
	...
	public GLIconRenderer(Context context, int style) {
		...
		color1 = context.getColor(R.color.brand);
		color2 = context.getColor(R.color.darker_brand);
	...
	public void updateColors() {
		isDarkBackground = style == DIALOG_STYLE && ColorUtils.calculateLuminance(context.getColor(R.color.background)) < 0.5f;
	}
}
