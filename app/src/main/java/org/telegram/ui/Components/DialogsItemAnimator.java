...
public class DialogsItemAnimator extends SimpleItemAnimator {
	...
	private static final TimeInterpolator sDefaultInterpolator = new DecelerateInterpolator();
	...
	private void animateRemoveImpl(final ViewHolder holder) {
		...
		if (view instanceof DialogCell dialogCell) {
	...
	@Override
	public boolean animateMove(final ViewHolder holder, ItemHolderInfo info, int fromX, int fromY, int toX, int toY) {
		final View view = holder.itemView;
	...
	@Override
	public boolean canReuseUpdatedViewHolder(ViewHolder viewHolder, @NonNull List<Object> payloads) {
