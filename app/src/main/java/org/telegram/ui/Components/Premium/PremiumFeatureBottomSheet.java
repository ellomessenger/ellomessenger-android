...
public class PremiumFeatureBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
	...
	private final PremiumPreviewFragment.SubscriptionTier selectedTier;
...
//            }
		...
		bottomPages.setColor(getContext().getColor(R.color.medium_gray), getContext().getColor(R.color.brand));
		if (!onlySelectedType) {
...
//                }
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.setBackgroundColor(getContext().getColor(R.color.background));
		actionBar.setTitleColor(getContext().getColor(R.color.text));
		actionBar.setItemsBackgroundColor(getContext().getColor(R.color.light_background), false);
		actionBar.setItemsColor(getContext().getColor(R.color.text), false);
	...
	protected boolean onCustomOpenAnimation() {
		if (viewPager.getChildCount() > 0) {
			...
			if (page.topView instanceof PremiumAppIconsPreviewView) {
				...
				valueAnimator.addUpdateListener(animation -> premiumAppIconsPreviewView.setOffset((Float)animation.getAnimatedValue()));
