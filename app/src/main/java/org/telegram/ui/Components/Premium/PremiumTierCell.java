...
public class PremiumTierCell extends ViewGroup {
	...
	private final TextView pricePerMonthView;
	private final TextView pricePerYearStrikeView;
	private final TextView pricePerYearView;

	private final int leftPaddingToTextDp = 12;
	private final int leftPaddingToCheckboxDp = 8;

	protected PremiumPreviewFragment.SubscriptionTier tier;
	protected TextView discountView;

	private final String colorKey1 = Theme.key_windowBackgroundWhite;
	private final String colorKey2 = Theme.key_windowBackgroundGray;
	...
	public PremiumTierCell(@NonNull Context context) {
		...
		checkBox.setColor(context.getColor(R.color.brand), context.getColor(R.color.brand), context.getColor(R.color.brand));
		addView(checkBox);
		...
		discountView.setTypeface(Theme.TYPEFACE_BOLD);
