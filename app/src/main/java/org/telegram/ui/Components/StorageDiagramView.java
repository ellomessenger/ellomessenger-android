...
public class StorageDiagramView extends View {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		super.onMeasure(MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(110), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(110), MeasureSpec.EXACTLY));
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < data.length; i++) {
			...
			if (data[i].firstDraw) {
				...
				data[i].paint.setColor(data[i].color);
		...
		if (layout1 != null) {
			canvas.save();
			canvas.translate((getMeasuredWidth() - layout1.getWidth()) >> 1, ((getMeasuredHeight() - layout1.getHeight() - layout2.getHeight()) >> 1) + AndroidUtilities.dp(2));
