...
public class FilterGLThread extends DispatchQueue {
	...
	private final int[] videoTexture = new int[1];
	private boolean videoFrameAvailable;

	private final FilterShaders filterShaders;
	...
	private boolean initGL() {
		...
		int[] configSpec = new int[]{EGL10.EGL_RENDERABLE_TYPE, EGL_OPENGL_ES2_BIT, EGL10.EGL_RED_SIZE, 8, EGL10.EGL_GREEN_SIZE, 8, EGL10.EGL_BLUE_SIZE, 8, EGL10.EGL_ALPHA_SIZE, 8, EGL10.EGL_DEPTH_SIZE, 0, EGL10.EGL_STENCIL_SIZE, 0, EGL10.EGL_NONE};
		EGLConfig eglConfig;
