...
public class LimitPreviewView extends LinearLayout {
    ...
    public LimitPreviewView(@NonNull Context context, int icon, int currentValue, int premiumLimit) {
        ...
        freeTextView.setTypeface(Theme.TYPEFACE_BOLD);
        ...
        defaultCount.setTypeface(Theme.TYPEFACE_BOLD);
        ...
        limitTextView.setTypeface(Theme.TYPEFACE_BOLD);
        ...
        premiumCount.setTypeface(Theme.TYPEFACE_BOLD);
