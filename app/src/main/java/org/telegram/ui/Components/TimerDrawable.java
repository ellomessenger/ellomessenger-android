...
public class TimerDrawable extends Drawable {
	...
	public TimerDrawable(Context context, Theme.ResourcesProvider resourcesProvider) {
		...
		timePaint.setTypeface(Theme.TYPEFACE_CONDENSED_BOLD);
	...
	public void draw(Canvas canvas) {
		...
		if (currentTtlIcon != null) {
			...
			AndroidUtilities.rectTmp2.set((int)(getBounds().centerX() - AndroidUtilities.dp(10.5f)), (int)(getBounds().centerY() - AndroidUtilities.dp(10.5f)), (int)(getBounds().centerX() - AndroidUtilities.dp(10.5f)) + currentTtlIcon.getIntrinsicWidth(), (int)(getBounds().centerY() - AndroidUtilities.dp(10.5f)) + currentTtlIcon.getIntrinsicHeight());
