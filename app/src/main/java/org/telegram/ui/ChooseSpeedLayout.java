...
public class ChooseSpeedLayout {
    ...
    public ChooseSpeedLayout(Context context, PopupSwipeBackLayout swipeBackLayout, Callback callback) {
        speedSwipeBackLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, 0);
        speedSwipeBackLayout.setFitItems(true);

        ActionBarMenuSubItem backItem = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_arrow_back, LocaleController.getString("Back", R.string.Back), false);
        ...
        ActionBarMenuSubItem item = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_speed_0_2, LocaleController.getString("SpeedVerySlow", R.string.SpeedVerySlow), false);
        ...
        item = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_speed_0_5, LocaleController.getString("SpeedSlow", R.string.SpeedSlow), false);
        item.setColors(0xfffafafa, 0xfffafafa);
        item.setOnClickListener((view) -> {
        ...
        item = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_speed_1, LocaleController.getString("SpeedNormal", R.string.SpeedNormal), false);
        item.setColors(0xfffafafa, 0xfffafafa);
        item.setOnClickListener((view) -> {
        ...
        item = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_speed_1_5, LocaleController.getString("SpeedFast", R.string.SpeedFast), false);
        item.setColors(0xfffafafa, 0xfffafafa);
        item.setOnClickListener((view) -> {
        ...
        item = ActionBarMenuItem.addItem(speedSwipeBackLayout, R.drawable.msg_speed_2, LocaleController.getString("SpeedVeryFast", R.string.SpeedVeryFast), false);
        item.setColors(0xfffafafa, 0xfffafafa);
        item.setOnClickListener((view) -> {
