	...
	private void syncButtons(boolean animated) {
		if (checkable) {
			...
			if (animated) {
				...
				animatorSet.playTogether(ObjectAnimator.ofFloat(deleteButton, View.ALPHA, deleteButtonValue), ObjectAnimator.ofFloat(deleteButton, View.SCALE_X, deleteButtonValue), ObjectAnimator.ofFloat(deleteButton, View.SCALE_Y, deleteButtonValue), ObjectAnimator.ofFloat(addButton, View.ALPHA, addButtonValue), ObjectAnimator.ofFloat(addButton, View.SCALE_X, addButtonValue), ObjectAnimator.ofFloat(addButton, View.SCALE_Y, addButtonValue));
