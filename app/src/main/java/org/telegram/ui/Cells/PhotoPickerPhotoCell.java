...
public class PhotoPickerPhotoCell extends FrameLayout {
	...
	public PhotoPickerPhotoCell(Context context) {
		...
		checkBox.setColor(context.getColor(R.color.brand), context.getColor(R.color.light_background), context.getColor(R.color.brand));
	...
	public void updateColors() {
		checkBox.setColor(getContext().getColor(R.color.brand), getContext().getColor(R.color.light_background), getContext().getColor(R.color.brand));
	}
	...
	public void setImage(MediaController.PhotoEntry photoEntry) {
		Drawable thumb = ResourcesCompat.getDrawable(getResources(), R.drawable.nophotos, null);
		if (photoEntry.thumbPath != null) {
			...
			if (photoEntry.isVideo) {
				...
				setContentDescription(getContext().getString(R.string.AttachVideo) + ", " + LocaleController.formatDuration(photoEntry.duration));
				imageView.setImage("vthumb://" + photoEntry.imageId + ":" + photoEntry.path, null, thumb);
			}
			else {
				videoInfoContainer.setVisibility(View.INVISIBLE);
				setContentDescription(getContext().getString(R.string.AttachPhoto));
