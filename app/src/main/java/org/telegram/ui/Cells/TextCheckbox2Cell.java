...
public class TextCheckbox2Cell extends FrameLayout {
	...
	public static final Property<TextCheckbox2Cell, Float> ANIMATION_PROGRESS = new AnimationProperties.FloatProperty<>("animationProgress") {
		@Override
	...
	public TextCheckbox2Cell(Context context, int padding, boolean dialog) {
		...
		checkbox.setColor(context.getColor(R.color.brand), context.getColor(R.color.disabled_text), context.getColor(R.color.brand));
