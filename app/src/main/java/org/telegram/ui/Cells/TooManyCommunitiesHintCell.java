...
public class TooManyCommunitiesHintCell extends FrameLayout {
    ...
    public TooManyCommunitiesHintCell(Context context) {
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(context.getColor(R.color.text), PorterDuff.Mode.MULTIPLY));
        ...
        headerTextView.setTypeface(Theme.TYPEFACE_BOLD);
