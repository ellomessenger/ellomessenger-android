...
public class UnlockPremiumView extends FrameLayout {
	...
	public UnlockPremiumView(@NonNull Context context, int type) {
		super(context);
		...
		descriptionTextView.setTextColor(ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText), 100));
