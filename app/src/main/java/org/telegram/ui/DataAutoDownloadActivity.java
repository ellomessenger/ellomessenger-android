...
public class DataAutoDownloadActivity extends BaseFragment {
	private final ArrayList<DownloadController.Preset> presets = new ArrayList<>();
	private final int currentType;
	private final DownloadController.Preset lowPreset;
	private final DownloadController.Preset mediumPreset;
	private final DownloadController.Preset highPreset;
	private final DownloadController.Preset typePreset;
	private final DownloadController.Preset defaultPreset;
			...
			public void onItemClick(@NonNull View view, int position, float x, float y) {
				if (position == autoDownloadRow) {
					...
					if (LocaleController.isRTL && x <= AndroidUtilities.dp(76) || !LocaleController.isRTL && x >= view.getMeasuredWidth() - AndroidUtilities.dp(76)) {
						...
						HeaderCell headerCell = new HeaderCell(getParentActivity(), 21, 15, 15, false);
						if (position == photosRow) {
						...
						if (position != photosRow) {
							...
							checkCell[0] = new TextCheckCell(getParentActivity(), 21);
		...
		public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
			switch (holder.getItemViewType()) {
				...
				case 4: {
					...
					view.setTextAndValueAndCheck(text, builder, count != 0, true, position != filesRow);
					break;
				}
				case 5: {
		...
		public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			switch (viewType) {
				case 0: {
					...
					cell.setTypeface(Theme.TYPEFACE_BOLD);
					cell.setHeight(56);
					view = cell;
					break;
				}
