...
public class DownloadProgressIcon extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        downloadImageReceiver.setImageCoordinates(padding, padding, getMeasuredWidth() - padding * 2, getMeasuredHeight() - padding * 2);
        downloadCompleteImageReceiver.setImageCoordinates(padding, padding, getMeasuredWidth() - padding * 2, getMeasuredHeight() - padding * 2);
    }
