...
public class PeopleNearbyActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, LocationController.LocationFetchCallback {
	...
	private final ArrayList<TLRPC.TL_peerLocated> users;
	private final ArrayList<TLRPC.TL_peerLocated> chats;
	...
	public View createView(@NonNull Context context) {
		...
		actionBar.setTitleColor(ResourcesCompat.getColor(context.getResources(), R.color.text, null));
		actionBar.setItemsColor(ResourcesCompat.getColor(context.getResources(), R.color.text, null), false);
		actionBar.setItemsBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.light_background, null), false);
		...
		fragmentView.setBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.light_background, null));
		...
		actionBarBackground = new View(context) {
			...
			protected void onDraw(Canvas canvas) {
				paint.setColor(ResourcesCompat.getColor(context.getResources(), R.color.background, null));
	...
	public static class HeaderCellProgress extends HeaderCell {
		...
		public HeaderCellProgress(Context context) {
			...
			progressView.setProgressColor(ResourcesCompat.getColor(context.getResources(), R.color.brand, null));
	...
	public class HintInnerCell extends FrameLayout {
		...
		public HintInnerCell(Context context) {
			...
			imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.dp(74), ResourcesCompat.getColor(getResources(), R.color.brand, null)));
			...
			titleTextView.setTextColor(ResourcesCompat.getColor(getResources(), R.color.text, null));
			...
			messageTextView.setTextColor(ResourcesCompat.getColor(getResources(), R.color.dark_gray, null));
		...
		public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
			...
			switch (viewType) {
				...
				case 4:
					...
					textView.setBackgroundColor(ResourcesCompat.getColor(textView.getResources(), R.color.background, null));
					textView.setPadding(0, 0, AndroidUtilities.dp(3), 0);
					textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 14);
					textView.setGravity(Gravity.CENTER);
					textView.setTextColor(ResourcesCompat.getColor(textView.getResources(), R.color.dark_gray, null));
					view = textView;
					break;
				case 5:
				default:
			...
			switch (holder.getItemViewType()) {
				case 0:
					...
					if (position >= usersStartRow && position < usersEndRow) {
						...
						User user = getMessagesController().getUser(peerLocated.peer.user_id);
						if (user != null) {
				...
				case 2:
					...
					actionCell.setColors(ResourcesCompat.getColor(actionCell.getResources(), R.color.brand, null), ResourcesCompat.getColor(actionCell.getResources(), R.color.brand, null));
					if (position == chatsCreateRow) {
						...
						if (showingMe = (getUserConfig().sharingMyLocationUntil > getConnectionsManager().getCurrentTime())) {
							...
							actionCell.setColors(ResourcesCompat.getColor(actionCell.getResources(), R.color.purple, null), ResourcesCompat.getColor(actionCell.getResources(), R.color.purple, null));
						}
						else {
	...
	public boolean isLightStatusBar() {
		int color = ResourcesCompat.getColor(getContext().getResources(), R.color.background, null);
