...
public class DefaultItemAnimator extends SimpleItemAnimator {
	...
	protected void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
		...
		animation.setDuration(getRemoveDuration()).setStartDelay(getRemoveDelay()).alpha(0).scaleX(1f - animateByScale(view)).scaleY(1f - animateByScale(view)).setListener(new AnimatorListenerAdapter() {
			@Override
	...
	public void animateAddImpl(final RecyclerView.ViewHolder holder) {
		...
		animation.alpha(1).scaleX(1f).scaleY(1f).setDuration(getAddDuration()).setStartDelay(getAddDelay()).setListener(new AnimatorListenerAdapter() {
			@Override
			public void onAnimationStart(Animator animator) {
	...
	protected void animateMoveImpl(final RecyclerView.ViewHolder holder, MoveInfo moveInfo) {
		...
		animation.setDuration(getMoveDuration()).setStartDelay(getMoveDelay()).setInterpolator(getMoveInterpolator()).setListener(new AnimatorListenerAdapter() {
			@Override
			public void onAnimationStart(Animator animator) {
	...
	void animateChangeImpl(final ChangeInfo changeInfo) {
		...
		if (view != null) {
			...
			oldViewAnim.alpha(0);
			if (animateByScale(view) > 0) {
				oldViewAnim.scaleX(1f - animateByScale(view)).scaleY(1f - animateByScale(view));
			}
		...
		if (newView != null) {
			...
			newViewAnimation.translationX(0).translationY(0).setDuration(getChangeAddDuration()).setStartDelay(getChangeDelay() + (getChangeDuration() - getChangeAddDuration())).alpha(1);
