...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
	 ...
	 */
	@SuppressWarnings("WeakerAccess") /* synthetic access */ ViewHolder mSelected = null;
	 ...
	 */
	@SuppressWarnings("WeakerAccess") /* synthetic access */ int mActivePointerId = ACTIVE_POINTER_ID_NONE;
	 ...
	 * action state.
	 */
	@SuppressWarnings("WeakerAccess") /* synthetic access */ int mSelectedFlags;
	 ...
	 */
	@SuppressWarnings("WeakerAccess") /* synthetic access */ final Runnable mScrollRunnable = new Runnable() {
		@Override
		public void run() {
	 ...
	 */
	@SuppressWarnings("WeakerAccess") /* synthetic access */ View mOverdrawChild = null;
	 ...
	 * detached.
	 */
	@SuppressWarnings("WeakerAccess") /* synthetic access */ int mOverdrawChildPosition = -1;

	/**
	 * Used to detect long press.
	 */
	@SuppressWarnings("WeakerAccess") /* synthetic access */ GestureDetectorCompat mGestureDetector;
	...
	private boolean withRecover = false;
	...
	public ItemTouchHelper(@NonNull Callback callback, boolean withRecover) {
		mCallback = callback;
		this.withRecover = withRecover;
	}
	...
	/**
	 * <p>Clear any swipe effects from viewHolder</p>
	 * <p>
	 * <a href="https://stackoverflow.com/a/71153427/318460">https://stackoverflow.com/a/71153427/318460</a>
	 * </p>
	 *
	 * @param viewHolder the view holder to recover
	 */
	private void recoverOnSwiped(@NonNull RecyclerView.ViewHolder viewHolder) {
	...
	public int checkHorizontalSwipe(ViewHolder viewHolder, int flags) {
		if ((flags & (LEFT | RIGHT)) != 0) {
			...
			if (viewHolder != null) {
				...
				threshold = mRecyclerView.getWidth();
			}
