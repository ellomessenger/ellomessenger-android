...
extern std::string serverPublicKey;
extern long long serverPublicKeyFingerprint;
        ...
        if (authNonce->isEqualTo(result->nonce.get())) {
            ...
            if (currentDatacenter->isCdnDatacenter) {
                ...
                if (serverPublicKeys.empty()) {
					serverPublicKeys.emplace_back(serverPublicKey);
					serverPublicKeysFingerprints.push_back(serverPublicKeyFingerprint);
                }
