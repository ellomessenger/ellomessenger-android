...
private:
    ...
    Connection *proxyConnection[PROXY_CONNECTIONS_COUNT] = {nullptr};
    Connection *downloadConnection[DOWNLOAD_CONNECTIONS_COUNT] = {nullptr};
    Connection *uploadConnection[UPLOAD_CONNECTIONS_COUNT] = {nullptr};
